...
RUN echo "========================================"
RUN echo "CEK DEBUG VARIABLE:"
RUN echo "API KEY SERVER: $GOOGLE_API_KEY"
RUN echo "FIREBASE KEY: $NEXT_PUBLIC_FIREBASE_API_KEY"
RUN echo "PROJECT ID: $NEXT_PUBLIC_FIREBASE_PROJECT_ID"
RUN echo "========================================"
# --------------------------------------
